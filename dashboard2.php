        ...
        <ul class="menu">
          ...
          <li class="menu-item">
            <a class="menu-link" href="reminder.php">
              ...
              <span class="title">Reminders<small>Details <span class="badge badge-pill badge-success" id="remnum"><small> </small> </span> </small></span>  
            </a>
          </li>
...
<div data-aos="fade-up" class="divider fs-16">Reminders Today</div>


    <div class="todo-calendar todo-block">
    <button id="checkbut"  >ADD REMINDER <span class="badge badge-pill  badge-light" id="remnum2"><small> </small> </span> </button>
...
need to ensure security has never been greater.</p>
            ...
            <button id="checkbut" >click here</button>
